  ...
  return (0, import_jsx_runtime31.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime30.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime30.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min2 && mark.value <= max2).map((mark, index) => {
      ...
      return (0, import_jsx_runtime31.jsxs)(Thumb, _extends({
        ...
        style: _extends({}, style2, getThumbStyle(index), thumbProps.style, resolvedSlotProps == null ? void 0 : resolvedSlotProps.style),
...
function useTheme(defaultTheme5 = null) {
  const contextTheme = React74.useContext(ThemeContext);
...
var RtlContext = React81.createContext();
...
function InitColorSchemeScript(options) {
  ...
  return (0, import_jsx_runtime54.jsx)("script", {
...
function useCurrentColorScheme(options) {
  ...
  const setMode = React84.useCallback((mode) => {
  ...
  const setColorScheme = React84.useCallback((value) => {
    if (!value) {
      setState((currentState) => {
        try {
  ...
  const handleMediaQuery = React84.useCallback((event) => {
  ...
  const mediaListener = React84.useRef(handleMediaQuery);
...
function createCssVarsProvider(options) {
  ...
  const ColorSchemeContext = React85.createContext(void 0);
  if (true) {
    ColorSchemeContext.displayName = "ColorSchemeContext";
  }
  const useColorScheme2 = () => {
    const value = React85.useContext(ColorSchemeContext);
    if (!value) {
  ...
  function CssVarsProvider2(props) {
    ...
    const hasMounted = React85.useRef(false);
    const upperTheme = useTheme3();
    const ctx = React85.useContext(ColorSchemeContext);
    ...
    const element = (0, import_jsx_runtime56.jsxs)(React85.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime56.jsxs)(React85.Fragment, {
        children: [(0, import_jsx_runtime55.jsx)(GlobalStyles, {
          styles: {
            [colorSchemeSelector]: rootCss
          }
        }), (0, import_jsx_runtime55.jsx)(GlobalStyles, {
          styles: defaultColorSchemeStyleSheet
        }), (0, import_jsx_runtime55.jsx)(GlobalStyles, {
          styles: otherColorSchemesStyleSheet
        })]
      }), (0, import_jsx_runtime55.jsx)(ThemeProvider_default2, {
    ...
    return (0, import_jsx_runtime55.jsx)(ColorSchemeContext.Provider, {
      value: contextValue,
      children: element
    });
  }
...
init_objectWithoutPropertiesLoose();
init_deepmerge();
var _excluded34 = ["colorSchemes", "components", "defaultColorScheme"];
...
function createContainer(options = {}) {
  ...
  const Container2 = React86.forwardRef(function Container3(inProps, ref) {
...
function createGrid(options = {}) {
  ...
  const GridOverflowContext = React87.createContext(void 0);
  if (true) {
  ...
  const Grid2 = React87.forwardRef(function Grid3(inProps, ref) {
    var _inProps$columns, _inProps$spacing, _ref, _inProps$rowSpacing, _ref2, _inProps$columnSpacin, _ref3, _disableEqualOverflow;
    const theme = useTheme_default();
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const overflow2 = React87.useContext(GridOverflowContext);
    const {
      className,
      children,
    ...
    let result = (0, import_jsx_runtime58.jsx)(GridRoot, _extends({
      ...
      children: React87.Children.map(children, (child) => {
        if (React87.isValidElement(child) && isMuiElement(child, ["Grid"])) {
...
function createStack(options = {}) {
  ...
  const Stack2 = React88.forwardRef(function Grid2(inProps, ref) {
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const {
      component = "div",
...
// node_modules/@mui/material/styles/experimental_extendTheme.js
var _excluded39 = ["colorSchemes", "cssVarPrefix", "shouldSkipGeneratingVar"];
...
function extendTheme(options = {}, ...args) {
  ...
  } = options, input = _objectWithoutPropertiesLoose(options, _excluded39);
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-34HQYJCK.js.map
